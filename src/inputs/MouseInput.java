...
public class MouseInput
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (game.getGameState() == 4) {
            ...
            if (Inventory.isVisible()) {
                ...
                if (LevelDesigner.TYPE == 5) {
                    ...
                    new TextBox(game.getLevelDesigner(), 0);
                } else {
        ...
        if (game.getGameState() == 2) {
            ...
            for(int i = 0; i < game.getMenu("main").getComponentList().size(); i++){
                Object o = game.getMenu("main").getComponentList().get(i);
                Button b = null;
                ...
                if(x > b.x && y > b.y && x < b.x + b.width && y < b.y + b.height){
                    ...
                    else if(b.getName().equals("online")){
                        game.setGameState(4);
